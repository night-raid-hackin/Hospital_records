...
<button onClick={onConnect} className="border-2 border-[#FFC7C7] rounded-full px-12 py-2 inline-block mt-10 font-semibold hover:bg-[#FFC7C7] hover:text-black w-30%">Connect</button> 
</main>
</div>
